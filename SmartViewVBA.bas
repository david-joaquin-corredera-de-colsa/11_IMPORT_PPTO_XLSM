...
' Copyright (c) 1992, 2021, Oracle and/or its affiliates. All Rights Reserved.
'
...
Public Declare PtrSafe Function HypUpdateConnection Lib "HsAddin" (ByVal vtProviderType As Variant, _
                                                             ByVal vtServerName As Variant, _
                                                             ByVal vtApplicationName As Variant, _
                                                             ByVal vtDatabaseName As Variant, _
                                                             ByVal vtProviderURL As Variant, _
...
Public Declare PtrSafe Function HypOpenFlexForm Lib "HsAddin" (ByVal vtSheetName As Variant, _
                                                   ByVal vtFolderPath As Variant, _
                                                   ByVal vtFormName As Variant, _
                                                   ByRef vtDimensionList() As Variant, _
                                                   ByRef vtMemberList() As Variant) As Long
                                                   
Public Declare PtrSafe Function HypSetUserVariable Lib "HsAddin" (ByVal vtFriendlyName As Variant, _
                                                  ByVal vtDimensionName As Variant, _
                                                  ByVal vtUserVariableName As Variant, _
                                                  ByVal vtMemberName As Variant) As Long
                                                  
Public Declare PtrSafe Function HypListUserVariables Lib "HsAddin" (ByVal vtFriendlyName As Variant, _
                                                    ByRef vtDimensionNames As Variant, _
                                                    ByRef vtUserVariableNames As Variant, _
...
Public Declare Function HypUpdateConnection Lib "HsAddin" (ByVal vtProviderType As Variant, _
                                                             ByVal vtServerName As Variant, _
                                                             ByVal vtApplicationName As Variant, _
                                                             ByVal vtDatabaseName As Variant, _
                                                             ByVal vtProviderURL As Variant, _
...
Public Declare Function HypOpenFlexForm Lib "HsAddin" (ByVal vtSheetName As Variant, _
                                                   ByVal vtFolderPath As Variant, _
                                                   ByVal vtFormName As Variant, _
                                                   ByRef vtDimensionList() As Variant, _
                                                   ByRef vtMemberList() As Variant) As Long
                                                   
Public Declare Function HypSetUserVariable Lib "HsAddin" (ByVal vtFriendlyName As Variant, _
                                                  ByVal vtDimensionName As Variant, _
                                                  ByVal vtUserVariableName As Variant, _
                                                  ByVal vtMemberName As Variant) As Long
                                                  
Public Declare Function HypListUserVariables Lib "HsAddin" (ByVal vtFriendlyName As Variant, _
                                                    ByRef vtDimensionNames As Variant, _
                                                    ByRef vtUserVariableNames As Variant, _
                                                    ByRef vtMemberNames As Variant) As Long
'**************************************************************************
